            ...
            <div class="card-body projectCard">
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 mb-5">
                        <div class="card-img">
                            <img class="projectImages img-fluid mb-4" src="public/List_alk.jpg" alt="img">
                            <img class="projectImages img-fluid mb-4" src="public/szures.jpg" alt="img">
                            <img class="projectImages img-fluid mb-4" src="public/Alk_details.jpg" alt="img">
                        </div>
                    </div>
                </div>
            </div>
